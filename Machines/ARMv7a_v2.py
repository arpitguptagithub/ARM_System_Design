...
# fn data needed.
    ...
    def handle_return(self):
        ...
        return [
            ...
            f"LDR {self.argument_stack_ptr}, [{self.compute_stack_ptr}]",
            f"SUB {self.compute_stack_ptr}, {self.compute_stack_ptr}, #4",
            
            f"LDR {self.local_stack_ptr}, [{self.compute_stack_ptr}]",
            f"SUB {self.compute_stack_ptr}, {self.compute_stack_ptr}, #4",
            f"LDR R0, [{self.compute_stack_ptr}]",
    ...
    def handle_call(self, function_name, num_args):
        ...
        return [
            ...
            # Set new ARG
            f"SUB {self.argument_stack_ptr}, {self.compute_stack_ptr}, #{4 * (int(num_args) + 3)}",
